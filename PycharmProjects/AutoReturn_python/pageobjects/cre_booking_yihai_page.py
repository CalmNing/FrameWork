...
class CreBookingYihaiPage(BasePage):

    # def __init__(self, driver):
    #     super(CreBookingYihaiPage, self).__init__(driver)
    ...
    def my_order(self):
        ...
        print("********************  订单详情页，确定信息(booking核对创建订单)：********************")
